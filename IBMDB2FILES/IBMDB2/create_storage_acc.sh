...
LOCATION="eastus"
RESOURCE_GROUP="rg-db2-demo-eastus-001"
BLOCK_STORAGE_ACCOUNT="stdb2blockstoracct"
FILE_STORAGE_ACCOUNT="stdb2filestoracct"
CLUSTER="aks-db2-demo-eastus-001"
NODE_POOL="npdb2demo"
NODE_VM_SIZE="Standard_D4_v3"
NUM_NODES=1
BLOCK_STORAGE_ACCOUNT="nbdb2blockstoracct"
FILE_STORAGE_ACCOUNT="nbdb2filestoracct"
...
# az storage account create --name ${BLOCK_STORAGE_ACCOUNT} --resource-group ${RESOURCE_GROUP} --location ${LOCATION} Standard_LRS --kind BlockBlobStorage
...
#     --resource-group ${RESOURCE_GROUP} \
#     --storage-account ${BLOCK_STORAGE_ACCOUNT} \
#     --name ${FILE_STORAGE_ACCOUNT} \
#     --quota 1024 \
#     --enabled-protocols SMB \
#     --output none

# az storage account create -name ${BLOCK_STORAGE_ACCOUNT} -g ${RESOURCE_GROUP} -l ${LOCATION} --sku Premium_LRS --kind BlockBlobStorage
# az storage account create -name ${FILE_STORAGE_ACCOUNT} -gp ${RESOURCE_GROUP} -l ${LOCATION} --sku Premium_LRS --kind FileStorage
# az storage account create --name ${BLOCK_STORAGE_ACCOUNT} --resource-group ${RESOURCE_GROUP} --location ${LOCATION} --sku Standard_LRS --kind FileStorage
